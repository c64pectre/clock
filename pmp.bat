rem    clock: Clock application for the Commodore 64.
...
rem
rem    Contact: https://github.com/c64pectre/clock/ create an issue

set PMP_PROJECT_GROUP_ID=c64pectre
set PMP_PROJECT_ARTIFACT_ID=clock
